...
Our second illustration of the NNC procedure in the context of behavior change uses a recent ‘nudging’ study (Lehmann, Chapman, Franssen, Kok, & Ruiter, 2016). By changing the default ‘opt-in’ to ‘opt-out’ in an e-mail invitation to employees to get vaccinated, these researchers made the following counts given condition:
